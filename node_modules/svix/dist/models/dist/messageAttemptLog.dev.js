...
var httpAttemptTimes_1 = require("./httpAttemptTimes");
...
exports.MessageAttemptLogSerializer = {
  _fromJsonObject: function _fromJsonObject(object) {
    return {
      ...
      httpTimes: object["httpTimes"] != null ? httpAttemptTimes_1.HttpAttemptTimesSerializer._fromJsonObject(object["httpTimes"]) : undefined,
  ...
  _toJsonObject: function _toJsonObject(self) {
    return {
      ...
      httpTimes: self.httpTimes != null ? httpAttemptTimes_1.HttpAttemptTimesSerializer._toJsonObject(self.httpTimes) : undefined,
