  ...
  return function () {
    ...
    3: [function (require, module, exports) {
      ...
      var utils = require(5),
        ...
        return e.replace(/&#(\d+);/g, function (e, t) {
          ...
          parseArrayValue = function parseArrayValue(e, t, r) {
        ...
        var a = t.parameterLimit === 1 / 0 ? void 0 : t.parameterLimit,
            o = i.split(t.delimiter, t.throwOnLimitExceeded && void 0 !== a ? a + 1 : a);
        if (t.throwOnLimitExceeded && void 0 !== a && o.length > a) throw new RangeError("Parameter limit exceeded. Only " + a + " parameter" + (1 === a ? "" : "s") + " allowed.");
        var l,
            n = -1,
            s = t.charset;
        if (t.charsetSentinel) for (l = 0; l < o.length; ++l) {
          0 === o[l].indexOf("utf8=") && (o[l] === charsetSentinel ? s = "utf-8" : o[l] === isoSentinel && (s = "iso-8859-1"), n = l, l = o.length);
        }
        ...
        for (l = 0; l < o.length; ++l) {
          if (l !== n) {
            ...
            if (-1 === y ? (d = t.decoder(p, defaults.decoder, s, "key"), c = t.strictNullHandling ? null : "") : null !== (d = t.decoder(p.slice(0, y), defaults.decoder, s, "key")) && (c = utils.maybeMap(parseArrayValue(p.slice(y + 1), t, isArray(r[d]) ? r[d].length : 0), function (e) {
              return t.decoder(e, defaults.decoder, s, "value");
            })), c && t.interpretNumericEntities && "iso-8859-1" === s && (c = interpretNumericEntities(String(c))), p.indexOf("[]=") > -1 && (c = isArray(c) ? [c] : c), t.comma && isArray(c) && c.length > t.arrayLimit) {
              ...
              c = utils.combine([], c, t.arrayLimit, t.plainObjects);
            }

            if (null !== d) {
              var f = has.call(r, d);
              f && ("combine" === t.duplicates || p.indexOf("[]=") > -1) ? r[d] = utils.combine(r[d], c, t.arrayLimit, t.plainObjects) : f && "last" !== t.duplicates || (r[d] = c);
            }
          }
        }
        ...
        return r;
          ...
          parseObject = function parseObject(e, t, r, i) {
        var a = 0;
        ...
        for (var l = i ? t : parseArrayValue(t, r, a), n = e.length - 1; n >= 0; --n) {
          var s,
              d = e[n];
          if ("[]" === d && r.parseArrays) s = utils.isOverflow(l) ? l : r.allowEmptyArrays && ("" === l || r.strictNullHandling && null === l) ? [] : utils.combine([], l, r.arrayLimit, r.plainObjects);else {
            s = r.plainObjects ? {
              __proto__: null
            } : {};
            var c = "[" === d.charAt(0) && "]" === d.charAt(d.length - 1) ? d.slice(1, -1) : d,
                p = r.decodeDotInKeys ? c.replace(/%2E/g, ".") : c,
                u = parseInt(p, 10),
                y = !isNaN(u) && d !== p && String(u) === p && u >= 0 && r.parseArrays;
            if (r.parseArrays || "" !== p) {
              if (y && u < r.arrayLimit) (s = [])[u] = l;else {
                if (y && r.throwOnLimitExceeded) throw new RangeError("Array limit exceeded. Only " + r.arrayLimit + " element" + (1 === r.arrayLimit ? "" : "s") + " allowed in an array.");
                y ? (s[u] = l, utils.markOverflow(s, u)) : "__proto__" !== p && (s[p] = l);
              }
            } else s = {
              0: l
            };
        ...
        if (t.depth <= 0) {
          if (!t.plainObjects && has.call(Object.prototype, r) && !t.allowPrototypes) return;
          return [r];
        }
        ...
        if (o) {
          if (!t.plainObjects && has.call(Object.prototype, o) && !t.allowPrototypes) return;
          l[l.length] = o;
        }
        ...
        return {
          ...
          strictMerge: "boolean" == typeof e.strictMerge ? !!e.strictMerge : defaults.strictMerge,
      ...
      module.exports = function (e, t) {
        ...
        for (var i = "string" == typeof e ? parseValues(e, r) : e, a = r.plainObjects ? {
          __proto__: null
        } : {}, o = Object.keys(i), l = 0; l < o.length; ++l) {
          var n = o[l],
    ...
    4: [function (require, module, exports) {
      ...
      var getSideChannel = require(46),
        ...
        for (var g = e, w = v, b = 0, A = !1; void 0 !== (w = w.get(sentinel)) && !A;) {
          var D = w.get(e);
        ...
        if ("function" == typeof f ? g = f(r, g) : g instanceof Date ? g = y(g) : "comma" === t && isArray(g) && (g = utils.maybeMap(g, function (e) {
        ...
        if (isNonNullishPrimitive(g) || utils.isBuffer(g)) return s ? [p(m ? r : s(r, defaults.encoder, h, "key", c)) + "=" + p(s(g, defaults.encoder, h, "value", c))] : [p(r) + "=" + p(String(g))];
        var S,
            E = [];
        if (void 0 === g) return E;
        if ("comma" === t && isArray(g)) m && s && (g = utils.maybeMap(g, s)), S = [{
          value: g.length > 0 ? g.join(",") || null : void 0
        }];else if (isArray(f)) S = f;else {
          var N = Object.keys(g);
          S = u ? N.sort(u) : N;
        }
        ...
        for (var k = 0; k < S.length; ++k) {
          var I = S[k],
              P = "object" == _typeof(I) && I && void 0 !== I.value ? I.value : g[I];

          if (!i || null !== P) {
            var x = d && l ? String(I).replace(/\./g, "%2E") : String(I),
                z = isArray(g) ? "function" == typeof t ? t(O, x) : O : O + (d ? "." + x : "[" + x + "]");
            v.set(e, b);
            var K = getSideChannel();
            K.set(sentinel, v), pushToArray(E, stringify(P, z, t, o, a, n, i, l, "comma" === t && m && isArray(g) ? null : s, f, u, d, y, c, p, m, h, K));
          }
        }
      ...
      module.exports = function (e, r) {
        ...
        for (var s = getSideChannel(), f = 0; f < t.length; ++f) {
          var u = t[f],
              d = o[u];
          a.skipNulls && null === d || pushToArray(n, stringify(d, u, i, l, a.allowEmptyArrays, a.strictNullHandling, a.skipNulls, a.encodeDotInKeys, a.encode ? a.encoder : null, a.filter, a.sort, a.allowDots, a.serializeDate, a.format, a.formatter, a.encodeValuesOnly, a.charset, s));
        }

        var y = n.join(a.delimiter),
            c = !0 === a.addQueryPrefix ? "?" : "";
        return a.charsetSentinel && ("iso-8859-1" === a.charset ? c += "utf8=%26%2310003%3B&" : c += "utf8=%E2%9C%93&"), y.length > 0 ? c + y : "";
      };
    }, {
      "1": 1,
      "46": 46,
    ...
    5: [function (require, module, exports) {
      ...
      var formats = require(1),
        ...
        if ("object" != _typeof(r) && "function" != typeof r) {
          if (isArray(e)) {
            var n = e.length;
            if (t && "number" == typeof t.arrayLimit && n > t.arrayLimit) return markOverflow(arrayToObject(e.concat(r), t), n);
            e[n] = r;
          } else {
        ...
        if (!e || "object" != _typeof(e)) {
          if (isOverflow(r)) {
            for (var a = Object.keys(r), i = t && t.plainObjects ? {
              __proto__: null,
              0: e
            } : {
              0: e
            }, c = 0; c < a.length; c++) {
              i[parseInt(a[c], 10) + 1] = r[a[c]];
            }

            return markOverflow(i, getMaxIndex(r) + 1);
          }

          var l = [e].concat(r);
          return t && "number" == typeof t.arrayLimit && l.length > t.arrayLimit ? markOverflow(arrayToObject(l, t), l.length - 1) : l;
        }

        var f = e;
        return isArray(e) && !isArray(r) && (f = arrayToObject(e, t)), isArray(e) && isArray(r) ? (r.forEach(function (r, n) {
          if (has.call(e, n)) {
            var o = e[n];
            o && "object" == _typeof(o) && r && "object" == _typeof(r) ? e[n] = merge(o, r, t) : e[e.length] = r;
          } else e[n] = r;
        }), e) : Object.keys(r).reduce(function (e, n) {
          var o = r[n];

          if (has.call(e, n) ? e[n] = merge(e[n], o, t) : e[n] = o, isOverflow(r) && !isOverflow(e) && markOverflow(e, getMaxIndex(r)), isOverflow(e)) {
            var a = parseInt(n, 10);
            String(a) === n && a >= 0 && a > getMaxIndex(e) && setMaxIndex(e, a);
          }
        ...
        try {
          ...
          limit = 1024,
          encode = function encode(e, r, t, n, o) {
        ...
        for (var i = "", c = 0; c < a.length; c += limit) {
          for (var l = a.length >= limit ? a.slice(c, c + limit) : a, f = [], s = 0; s < l.length; ++s) {
            var u = l.charCodeAt(s);
            45 === u || 46 === u || 95 === u || 126 === u || u >= 48 && u <= 57 || u >= 65 && u <= 90 || u >= 97 && u <= 122 || o === formats.RFC1738 && (40 === u || 41 === u) ? f[f.length] = l.charAt(s) : u < 128 ? f[f.length] = hexTable[u] : u < 2048 ? f[f.length] = hexTable[192 | u >> 6] + hexTable[128 | 63 & u] : u < 55296 || u >= 57344 ? f[f.length] = hexTable[224 | u >> 12] + hexTable[128 | u >> 6 & 63] + hexTable[128 | 63 & u] : (s += 1, u = 65536 + ((1023 & u) << 10 | 1023 & l.charCodeAt(s)), f[f.length] = hexTable[240 | u >> 18] + hexTable[128 | u >> 12 & 63] + hexTable[128 | u >> 6 & 63] + hexTable[128 | 63 & u]);
          }
        ...
        for (var r = [{
          ...
          for (var o = r[n], a = o.obj[o.prop], i = Object.keys(a), c = 0; c < i.length; ++c) {
            var l = i[c],
                f = a[l];
            "object" == _typeof(f) && null !== f && -1 === t.indexOf(f) && (r[r.length] = {
              obj: a,
              prop: l
            }, t[t.length] = f);
          }
        ...
        return !(!e || "object" != _typeof(e) || !(e.constructor && e.constructor.isBuffer && e.constructor.isBuffer(e)));
          ...
          combine = function combine(e, r, t, n) {
        if (isOverflow(e)) {
          var o = getMaxIndex(e) + 1;
          return e[o] = r, setMaxIndex(e, o), e;
        }

        var a = [].concat(e, r);
        return a.length > t ? markOverflow(arrayToObject(a, {
          plainObjects: n
        }), a.length - 1) : a;
      },
    ...
    46: [function (require, module, exports) {
      ...
      var $TypeError = require(20),
          ...
          makeChannel = getSideChannelWeakMap || getSideChannelMap || getSideChannelList;
    ...
    10: [function (require, module, exports) {
      ...
      module.exports = function callBindBasic(r) {
        if (r.length < 1 || "function" != typeof r[0]) throw new $TypeError("a function is required");
    ...
    12: [function (require, module, exports) {
      ...
      module.exports = function callBoundIntrinsic(i, n) {
        ...
        return "function" == typeof t && $indexOf(i, ".prototype.") > -1 ? callBindBasic([t]) : t;
      };
    }, {
      "10": 10,
      "25": 25
      ...
      module.exports = function GetIntrinsic(r, e) {
        ...
        for (var d = 1, s = !0; d < t.length; d += 1) {
          var f = t[d],
              l = $strSlice(f, 0, 1),
              u = $strSlice(f, -1);
          if (('"' === l || "'" === l || "`" === l || '"' === u || "'" === u || "`" === u) && l !== u) throw new $SyntaxError("property names with quotes must have matching quotes");
          if ("constructor" !== f && s || (y = !0), hasOwn(INTRINSICS, a = "%" + (o += "." + f) + "%")) i = INTRINSICS[a];else if (null != i) {
            if (!(f in i)) {
            ...
            if ($gOPD && d + 1 >= t.length) {
              var c = $gOPD(i, f);
              i = (s = !!c) && "get" in c && !("originalValue" in c.get) ? c.get : i[f];
    ...
    13: [function (require, module, exports) {
      ...
      try {
        ...
        if (!t || "object" != _typeof(t) || !("code" in t) || "ERR_PROTO_ACCESS" !== t.code) throw t;
      }

      var desc = !!hasProtoAccessor && gOPD && gOPD(Object.prototype, "__proto__"),
          $Object = Object,
          $getPrototypeOf = $Object.getPrototypeOf;
      module.exports = desc && "function" == typeof desc.get ? callBind([desc.get]) : "function" == typeof $getPrototypeOf && function getDunder(t) {
    ...
    28: [function (require, module, exports) {
      ...
      module.exports = reflectGetProto ? function getProto(t) {
        return reflectGetProto(t);
      } : originalGetProto ? function getProto(t) {
        if (!t || "object" != _typeof(t) && "function" != typeof t) throw new TypeError("getProto: not an object");
        return originalGetProto(t);
      } : getDunderProto ? function getProto(t) {
    ...
    36: [function (require, module, exports) {
      ...
      module.exports = Number.isNaN || function isNaN(e) {
        return e != e;
      };
    }, {}],
      ...
      (function (global) {
        (function () {
          ...
          function canTrustToString(t) {
            return !toStringTag || !("object" == _typeof(t) && (toStringTag in t || void 0 !== t[toStringTag]));
          }
          ...
          module.exports = function inspect_(t, e, r, n) {
            var o = e || {};
            if (has(o, "quoteStyle") && !has(quotes, o.quoteStyle)) throw new TypeError('option "quoteStyle" must be "single" or "double"');
            ...
            if (void 0 === r && (r = 0), r >= u && u > 0 && "object" == _typeof(t)) return isArray(t) ? "[Array]" : "[Object]";
            var p = getIndent(o, r);
            ...
            if ("function" == typeof t && !isRegExp(t)) {
              ...
              return "[Function" + (s ? ": " + s : " (anonymous)") + "]" + (f.length > 0 ? " { " + $join.call(f, ", ") + " }" : "");
            }
            ...
            if (isElement(t)) {
              for (var S = "<" + $toLowerCase.call(String(t.nodeName)), g = t.attributes || [], m = 0; m < g.length; m++) {
            ...
            if (!isDate(t) && !isRegExp(t)) {
              var j = arrObjKeys(t, inspect),
                  ...
                  v = !w && toStringTag && Object(t) === t && toStringTag in t ? $slice.call(toStr(t), 8, -1) : $ ? "Object" : "",
                  k = (w || "function" != typeof t.constructor ? "" : t.constructor.name ? t.constructor.name + " " : "") + (v || $ ? "[" + $join.call($concat.call([], v || [], $ || []), ": ") + "] " : "");
              return 0 === j.length ? k + "{}" : p ? k + "{" + indentedJoin(j, p) + "}" : k + "{ " + $join.call(j, ", ") + " }";
            }
          ...
          function inspectString(t, e) {
            ...
            return o.lastIndex = 0, wrapQuotes($replace.call($replace.call(t, o, "\\$1"), /[\x00-\x1f]/g, lowbyte), "single", e);
          }
          ...
          function arrObjKeys(t, e) {
            ...
            if ("function" == typeof gOPS) for (var u = 0; u < a.length; u++) {
              isEnumerable.call(t, a[u]) && n.push("[" + e(a[u]) + "]: " + e(t[a[u]], t));
            }
            return n;
          }
        }).call(this);
    ...
    43: [function (require, module, exports) {
      ...
      var inspect = require(42),
          $TypeError = require(20),
          listGetNode = function listGetNode(e, t, n) {
        ...
        return !!e && !!listGetNode(e, t);
          ...
          listDelete = function listDelete(e, t) {
      ...
      module.exports = function getSideChannelList() {
        var e,
            t = {
          assert: function assert(e) {
            if (!t.has(e)) throw new $TypeError("Side channel does not contain " + inspect(e));
          },
    ...
    45: [function (require, module, exports) {
      ...
      module.exports = $WeakMap ? function getSideChannelWeakMap() {
        var e,
          ...
          get: function get(a) {
            return $WeakMap && a && ("object" == _typeof(a) || "function" == typeof a) && e ? $weakMapGet(e, a) : t && t.get(a);
          },
          has: function has(a) {
            return $WeakMap && a && ("object" == _typeof(a) || "function" == typeof a) && e ? $weakMapHas(e, a) : !!t && t.has(a);
          },
          set: function set(a, n) {
            $WeakMap && a && ("object" == _typeof(a) || "function" == typeof a) ? (e || (e = new $WeakMap()), $weakMapSet(e, a, n)) : getSideChannelMap && (t || (t = getSideChannelMap()), t.set(a, n));
          }
        };
        return a;
      } : getSideChannelMap;
