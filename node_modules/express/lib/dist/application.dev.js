...
app.init = function init() {
  ...
  this.defaultConfiguration(); // Setup getting to lazily add base router
...
app.handle = function handle(req, res, callback) {
  ...
  req.res = res;
  res.req = req; // alter the prototypes

  Object.setPrototypeOf(req, this.request);
  Object.setPrototypeOf(res, this.response); // setup locals
...
app.render = function render(name, options, callback) {
  ...
  var renderOptions = _objectSpread({}, this.locals, {}, opts._locals, {}, opts); // set .cache unless explicitly provided
