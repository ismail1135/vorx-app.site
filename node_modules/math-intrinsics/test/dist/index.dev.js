...
test('isInteger', function (t) {
  forEach([].concat( // @ts-expect-error TS sucks with concat
  v.nonNumbers, v.nonIntegerNumbers), function (nonInteger) {
...
test('isNaN', function (t) {
  forEach([].concat( // @ts-expect-error TS sucks with concat
  v.nonNumbers, v.infinities, v.zeroes, v.integerNumbers), function (nonNaN) {
...
test('constants', function (t) {
  t.equal(_typeof(maxArrayLength), 'number', 'typeof maxArrayLength === "number"');
  t.equal(_typeof(maxSafeInteger), 'number', 'typeof maxSafeInteger === "number"');
  t.equal(_typeof(maxValue), 'number', 'typeof maxValue === "number"');
  t.end();
});