...
var mergeModules = require("./helpers/merge-exports"); // All codecs and aliases are kept here, keyed by encoding name/alias.
// They are lazy loaded in `iconv.getCodec` from `encodings/index.js`.
// Cannot initialize with { __proto__: null } because Boolean({ __proto__: null }) === true


module.exports.encodings = null; // Characters emitted in case of error.

module.exports.defaultCharUnicode = "�";
module.exports.defaultCharSingleByte = "?"; // Public API.
...
module.exports.fromEncoding = module.exports.decode; // Search for a codec in iconv.encodings. Cache codec data in iconv._codecDataCache.
...
module.exports.getCodec = function getCodec(encoding) {
  if (!module.exports.encodings) {
    var raw = require("../encodings"); // TODO: In future versions when old nodejs support is removed can use object.assign
  ...
  var enc = module.exports._canonicalizeEncoding(encoding); // Traverse iconv.encodings to find actual codec.
...
module.exports.enableStreamingAPI = function enableStreamingAPI(streamModule) {
  ...
  var streams = require("./streams")(streamModule); // Not public API yet, but expose the stream classes.


  module.exports.IconvLiteEncoderStream = streams.IconvLiteEncoderStream;
  module.exports.IconvLiteDecoderStream = streams.IconvLiteDecoderStream; // Streaming API.
