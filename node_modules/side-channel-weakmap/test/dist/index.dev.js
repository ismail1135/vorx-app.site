...
test('getSideChannelMap', {
  ...
  t.test('export', function (st) {
    st.equal(_typeof(getSideChannel), 'function', 'is a function');
    st.equal(getSideChannel.length, 0, 'takes no arguments');
    var channel = getSideChannel();
    st.ok(channel, 'is truthy');
    st.equal(_typeof(channel), 'object', 'is an object');
    st.end();
  });
...
test('getSideChannelMap, no WeakMaps and/or Maps', {
  skip: typeof WeakMap === 'function' || typeof Map === 'function'
}, function (t) {
