...
benchmark_1.report("Base64 encode", benchmark_1.benchmark(function () {
  return base64_1.encode(buf);
}, buf.length)); // Decode benchmark reports MiB/s for decoded MiB, not input.

benchmark_1.report("Base64 decode", benchmark_1.benchmark(function () {
  return base64_1.decode(encBuf);
}, buf.length));
