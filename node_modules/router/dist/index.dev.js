...
Router.prototype.handle = function handle(req, res, callback) {
  ...
  function next(err) {
    ...
    while (match !== true && idx < stack.length) {
      ...
      var hasMethod = route._handlesMethod(method); // build up automatic options response
...
Router.prototype.use = function use(handler) {
  ...
  var callbacks = flatten.call(slice.call(arguments, offset), Infinity);
...
function mergeParams(params, parent) {
  ...
  var obj = Object.assign({}, parent); // simple non-numeric merging
...
function processParams(params, layer, called, req, res, done) {
  ...
  function param(err) {
    ...
    if (paramCalled && (paramCalled.match === paramVal || paramCalled.error && paramCalled.error !== 'route')) {
      // restore value
      req.params[key] = paramCalled.value; // next param
